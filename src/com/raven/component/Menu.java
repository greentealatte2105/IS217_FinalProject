...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
         addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/home.png")), "Home"));

        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/order.png")), "Order", "Table", "Beverage", "Food"));
