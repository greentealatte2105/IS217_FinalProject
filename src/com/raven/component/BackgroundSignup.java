 ...
 * @author RAVEN
 */
public class BackgroundSignup extends JComponent {
    ...
    private void createBlurImage(Graphics2D g) {
        ...
        if (width > 0 && height > 0) {
            ...
            Shape shape = new FancyBorderRadius(width, height, "84% 16% 70% 30% / 30% 74% 26% 70%").getShape();
            g2.fill(shape);
            ...
            g2.fill(shape);
            g2.dispose();
            g.drawImage(new ShadowRenderer(shadow, 0.3f, new Color(0, 0, 0)).createShadow(img), 
