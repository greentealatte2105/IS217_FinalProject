...
public class DateChooser extends JComponent {
    ...
    private void createHeader() {
        ...
        JButton cmdBack = new JButton(new ImageIcon(getClass().getResource("/com/raven/icon/icons8-back-24.png")));
        JButton cmdNext = new JButton(new ImageIcon(getClass().getResource("/com/raven/icon/icons8-front-24.jpg")));
